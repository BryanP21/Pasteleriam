...
if(!isset($_SESSION['usuario'])){
   ...
   $link= mysqli_connect($host,$dbuser,$dbpass,$db);
    ...
    $sql="SELECT * FROM sabor WHERE idsabor='$id'";
...
<!-------------------------INICIO TABLA SABORES REGISTROS------------->
	...
	<main class="frmdis4">
		<p class=Title1 style="color: white" font face="Alata" >Modificación de sabor</p>
		
		<form class="formregistros2"  action ="editarsabor.php" method="POST">

			
				<input type="hidden" name="idsabor" value="<?= $row['idsabor']?>"/>
