...
<!-------------------------INICIO TABLA EMPLEADOS REGISTROS------------->
	...
	<main class="frmdis2">
		<p class=Title1 style="color: white" font face="Alata" >Modificación de empleado</p>
		
		<form class="formregistros"  action ="editaempleado.php" method="POST">
            ...
            <div class='field3'>
				<h4>Tipo empleado</h4>
				<select name='tipoempleado' required placeholder='Tipo empleado' required>
