...
$tamano = "SELECT * FROM tamano";
$query = mysqli_query($link,$tamano);
?>
...
<!-------------------------INICIO TABLA Tamaños registos------------->

		
	
<main class="frmdis3">
	<p class=Title1 style="color: white" font face="Alata" >Registro de tamaño</p>
		
		<form class="formregistros2"  action ="insertartamano.php" method="POST"   >
	...
	<p class=Title5 style="color: white" font face="Alata" >Consulta de tamaños</p>
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_array($query)): ?>
                    ...
                    <tr>
                        ...
                        <th><a href="updatetamano.php?idtamano=<?= $row['idtamano'] ?>" class="users-table--edit">Editar</a></th>
                        <th><a href="eliminartamano.php?idtamano=<?= $row['idtamano'] ?>" class="users-table--delete" >Eliminar</a></th>
