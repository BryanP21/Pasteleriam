...
<!-------------------------INICIO TABLA SABORES REGISTROS------------->
	...
	<main class="frmdis4">
		<p class=Title1 style="color: white" font face="Alata" >Modificación de cobertura</p>
		
		<form class="formregistros2"  action ="editarcobertura.php" method="POST">

			
				<input type="hidden" name="idcobertura" value="<?= $row['idcobertura']?>"/>
