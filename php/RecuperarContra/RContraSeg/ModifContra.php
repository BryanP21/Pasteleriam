		...
		<div id="contenedor">
            <div id="central">
                <div id="login">
					...
					<br>
                    <form action="ModifContraCod.php"  name="frmAutentica" method="POST">
                    	<div class="row justify-content-center">
	                        <input type="text" name="usuario" placeholder="Usuario a buscar" required>
	                        				<div class="mt-1 mb-1"><br></div>
                        </div>
						<div class="row justify-content-center">
	                        <input type="password" name="contrasena" placeholder="Contraseña nueva" required>
	                        				<div class="mt-1 mb-1"><br></div>
                        </div>

						<div class="row justify-content-center">
	                        <input type="password" name="Ncontrasena" placeholder="Vuelve a escribir la contraseña" required>
	                        				<div class="mt-1 mb-1"><br></div>
                        </div>

	                    <div class="row justify-content-end"> 

						<input  type="submit"  name="modificar" value="Login" 
